...
class Game(models.Model):
    ...
    mini_board_winners = models.JSONField(
        default=list)  # Track 3x3 mini-board winners
    current_board = models.IntegerField(
        default=0)  # Which mini-board is active
    # Which mini-board the next player must play in (-1 = any)
    next_board = models.IntegerField(default=-1)
